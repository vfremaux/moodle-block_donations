...
$plugin->version   = 2013011000;        // The current plugin version (Date: YYYYMMDDXX)
$plugin->requires  = 2011112900;        // Requires this Moodle version
$plugin->component = 'block_donations';  // Full name of the plugin (used for diagnostics)
$plugin->cron = 0;
$plugin->release = '2.2.0 (Build 2013011000)';
$plugin->dependencies = array('donationsingle' => 2013011000);
